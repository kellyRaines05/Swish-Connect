...
# define the lower and upper boundaries of the brown ball (HSV)
brownLower = (6,57,65)
brownUpper = (18,63,91)
...
while True:
	...
	# construct a mask for the color brown, dilations and erosions to remove any small blobs in the mask
	mask = cv2.inRange(hsv, brownLower, brownUpper)
